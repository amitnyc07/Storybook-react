import styles from "./ActionItemTablet.module.scss";
...
const ActionItemTablet = ({ speaker, start, text, onTrash=()=>null}) => {
  const getTime=(ms)=>{
...
ActionItemTablet.propTypes = {
  speaker: string,
  start: number,
  text: string
}

ActionItemTablet.defaultProps = {
  speaker: 'Speaker1',
  start: 0,
  text: string
}
export default ActionItemTablet;
